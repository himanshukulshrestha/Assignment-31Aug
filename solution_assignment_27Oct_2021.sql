...
load data infile 'C:\Users\himanshu.kulshrestha\Documents\Others\Product.csv'
into table Product
...
( ItemId varchar(10),
  ...
  values ('M101' , 'HP Monitor', '23000'),
        ...
        ('M103' , 'LG Monito\r', '210000');
        
  select * into outfile 'C:\Users\himanshu.kulshrestha\Documents\OthersItem.csv'
  fields terminated by ','
